...
export default function Sesion({ navigation }) {
  ...
  const validarSesion = async () => {
    try {
      const response = await fetch(`${ip}/recuperacion/api/services/public/cliente.php?action=getUser`, {
        method: 'GET'
      });
  ...
  const cerrarSesion = async () => {
    try {
      const response = await fetch(`${ip}/recuperacion/api/services/public/cliente.php?action=logOut`, {
        method: 'GET'
      });
  ...
  const handlerLogin = async () => {
    ...
    try {
      ...
      const response = await fetch(`${ip}/recuperacion/api/services/public/cliente.php?action=logIn`, {
        method: 'POST',
        body: formData
      });
